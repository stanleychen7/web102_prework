...
const displayStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames}. ${totalUnfundedGames == 0 ? `All games are funded` : `Currently, ${totalUnfundedGames} games remains
